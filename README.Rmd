...
>
> The article is published in _North American Journal of Fisheries Management_.
...
Three other packages (and their dependencies) will simultaneously be installed: `r htmltools::img(src = "https://github.com/bstaton1/KuskoHarvPred/blob/v2023.3/inst/rstudio/KuskoHarvPred-tool/resources/all-logo-grouped.png?raw=true", align = "right", height = "250px")`
